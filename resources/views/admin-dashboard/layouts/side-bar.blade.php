   ...
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
       <div class="app-brand demo">
           <a href="index.html" class="app-brand-link">
               ...
               <span id="menu-text" class="app-brand-text demo menu-text fw-bold ms-2">MMcities</span>
           </a>
       ...
       <ul class="menu-inner py-1">
           ...
           <li class="menu-item">
               <a href="{{ url('/') }}" title="Dashboard" class="menu-link">
           ...
           <li class="menu-item">
               <a href="javascript:void(0);" class="menu-link menu-toggle">
                   ...
                   <div class="text-truncate" data-i18n="Dashboards">Lists</div>
                   <span class="badge rounded-pill bg-danger ms-auto">5</span>
               </a>
               <ul class="menu-sub">
                   <li class="menu-item">
                       <a href="{{ route('shop-owners.index') }}" class="menu-link">
                           <div class="text-truncate" data-i18n="Analytics">Shop Owners</div>
                       </a>
                   </li>
                   <li class="menu-item">
                       <a href="{{ route('packages.index') }}" class="menu-link">
                           <div class="text-truncate" data-i18n="CRM">Packages</div>
