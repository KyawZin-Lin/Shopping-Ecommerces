            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress m-t-30" style="height: 7px">
                        <div class="progress-bar bg-brand-color-1" role="progressbar" style="width: 50%" aria-valuenow="50"
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress m-t-30" style="height: 7px">
                        <div class="progress-bar bg-brand-color-2" role="progressbar" style="width: 35%" aria-valuenow="35"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress m-t-30" style="height: 7px">
                        <div class="progress-bar bg-brand-color-1" role="progressbar" style="width: 70%" aria-valuenow="70"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center justify-content-center card-active">
                        ...
                        <div class="col-6">
                            ...
                            <div class="progress">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: 70%; height: 6px"
                    ...
                    <div class="row align-items-center justify-content-center m-b-20">
                        ...
                        <div class="col-6">
                            <h6 class="d-flex align-items-center float-end m-0">
                                0.4 <i class="fas fa-caret-up text-success f-22 m-l-10"></i>
                            </h6>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                            <h6 class="align-items-center float-start">
                                <i class="fas fa-star f-10 m-r-10 text-warning"></i>
                                5
                            </h6>
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr class="unread">
                                    ...
                                    <td>
                                        <h6 class="text-muted">
                                            <i class="fas fa-circle text-danger f-10 m-r-15"></i>
                                            11 MAY 10:35
                                        </h6>
                                    </td>
                                    <td>
