...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
                ...
                <div class="card my-5">
                    <div class="row g-0">
                        <div
                            ...
                            <img src="{{ asset('shop-owner/assets/images/authentication/lock.png') }}" alt="lock images"
                                class="img-fluid">
                        </div>
                        <div class="col-md-8 col-lg-6">
                            <div class="card-body">
                                <div class="text-center">
                                    {{-- <a href="#">
                                        <img src="{{ asset('shop-owner/assets/images/logo-dark.svg') }}" alt="img">
                                    </a> --}}
                                </div>
    ...
    <div class="offcanvas border-0 pct-offcanvas offcanvas-end" tabindex="-1" id="offcanvas_pc_layout">
        <div class="offcanvas-header">
            ...
            <div class="d-inline-flex align-items-center gap-2">
                ...
                <a type="button" class="avtar avtar-xs btn-link-danger btn-pc-default" data-bs-dismiss="offcanvas"
                    aria-label="Close">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                <div class="theme-color preset-color">
                                    ...
                                    <a href="#!" data-bs-toggle="tooltip" title="Indigo" data-value="preset-2">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Purple" data-value="preset-3">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Pink" data-value="preset-4">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Red" data-value="preset-5">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Orange" data-value="preset-6">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Yellow" data-value="preset-7">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Green" data-value="preset-8">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Teal" data-value="preset-9">
                                        <i class="ti ti-checks"></i>
                                    </a>
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="theme-color header-color">
                                    ...
                                    <a href="#!" data-bs-toggle="tooltip" title="Blue" data-value="preset-1">
                                        <i class="ti ti-checks"></i>
                                    </a>
                                    <a href="#!" data-bs-toggle="tooltip" title="Indigo" data-value="preset-2">
                                        <i class="ti ti-checks"></i>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        ...
        data-cf-beacon='{"rayId":"8c5822236c16ce2d","version":"2024.8.0","r":1,"token":"dfc6ad2bc063456e85d5f100efcb73a2","serverTiming":{"name":{"cfExtPri":true,"cfL4":true}}}'
